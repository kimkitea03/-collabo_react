...
테스트 시나리오
    특정 상품에 대하여 '수정' 버튼을 클릭하면. 이전 상품 정보들이 입력한에 보여야 합니다.
...
function App({ user }) {
    ...
    const SubmitAction = async (event) => {
        ...
        try {
            ...
            // 상품 수정 후 입력 컨트롤은 모두 초기화 되어야 합니다.
    ...
    return (
        <Container>
            ...
            <Form onSubmit={SubmitAction}>
                ...
                {/* 자바의 Enum 열거형 타입에서 사용한 대문자를 반드시 사용해야합니다. */}
                <Form.Group className="mb-3">
                    ...
                    <Form.Select
                        ...
                        <option value="BEVERAGE">음류수</option>
                ...
                {/* 이미지는 type="file"이어야 하고, 이벤트 함수를 별개로 따로 만들도록 합니다. */}
                <Form.Group className="mb-3">
